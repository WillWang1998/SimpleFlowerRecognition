...
def train():
    ...
    learning_rate = tf.train.exponential_decay(LEARNING_RATE_BASE, global_step, len(training_labels) / BATCH,
                                               LEARNING_RATE_DECAY)
    ...
    with tf.Session() as sess:
        ...
        with tf.gfile.GFile(TRAIN_FILE, mode='wb') as f:
